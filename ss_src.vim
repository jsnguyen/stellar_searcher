...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 78 + 102) / 204)
exe 'vert 2resize ' . ((&columns * 125 + 102) / 204)
argglobal
...
argglobal
if bufexists("src/DateTime.c") | buffer src/DateTime.c | else | edit src/DateTime.c | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists("include/stellar_searcher/dateTime.h") | buffer include/stellar_searcher/dateTime.h | else | edit include/stellar_searcher/dateTime.h | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 62 - ((42 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
62
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 111 - ((31 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
111
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 190 - ((34 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
190
...
exe 'vert 2resize ' . ((&columns * 123 + 102) / 204)
tabnext
edit examples/stellarCoordinateTest.c
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
set winwidth=1
argglobal
if bufexists("examples/stellarCoordinateTest.c") | buffer examples/stellarCoordinateTest.c | else | edit examples/stellarCoordinateTest.c | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
badd +11 include/stellar_searcher/parser.h
badd +0 include/stellar_searcher/stellarCoordinate.h
badd +0 include/stellar_searcher/threeVector.h
badd +13 examples/celestialTimeExample.c
badd +1 120
badd +1 src/DateTime.c
badd +15 include/DateTime.h
badd +0 include/stellar_searcher/dateTime.h
badd +28 examples/starLocationExample.c
badd +0 examples/stellarCoordinateTest.c

...
set laststatus=2
set lazyredraw
set runtimepath=~/.vim,~/.vim/plugged/gruvbox,~/.vim/plugged/vim,~/.vim/plugged/falcon,~/.vim/plugged/seoul256.vim,~/.vim/plugged/vim-airline,~/.vim/plugged/julia-vim,/usr/local/share/vim/vimfiles,/usr/local/share/vim/vim82,/usr/local/share/vim/vimfiles/after,~/.vim/plugged/vim/after,~/.vim/after
set shiftwidth=2
set showcmd
set showmatch
set tabstop=2
...
exe 'vert 2resize ' . ((&columns * 123 + 102) / 204)
tabnext
edit include/stellar_searcher/dateTime.h
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
